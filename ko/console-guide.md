...
### 요청 파라미터 
리소스 메서드 별 요청 파라미터와 응답 형식, 콘텐츠 타입에 대한 설정을 합니다.  
설정한 내용은 [API 설명서](./console-guide/#_?)에 적용됩니다.
...
### API 설명서
배포된 스테이지 상태를 기반으로 Swagger UI 형태의 API 설명서를 볼 수 있습니다.

1. **스테이지**에서 **API 설명서** 탭을 선택합니다.
2. **게시 링크**에 나타나는 URL로 API 설명서를 볼 수 있습니다.
