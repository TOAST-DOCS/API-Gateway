...
설정한 내용은 [API 문서](./console-guide/#api_2)에 적용됩니다.
...
자세한 내용은 [API 문서](./console-guide/#api_2)를 참고합니다.
...
## API 문서
API 문서를 이용하면 API Gateway에 등록된 API의 명세를 웹페이지 문서로 관리할 수 있습니다.
...
2. 삭제 확인 창에서 **확인** 버튼을 클릭합니다. 삭제된 데이터는 복구할 수 없습니다.
