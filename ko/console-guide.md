...
예: 파라미터 이름과 값을 name,value로 설정하면  **name=value** 쿼리 문자열 파라미터가 백엔드 엔드포인트 요청시 추가됩니다. 
...
> **[참고] 요청 쿼리 문자열 파라미터 추가**
> - 원본 요청의 쿼리 문자열 파라미터와 같은 키를 갖는 요청 쿼리 문자열 파라미터는 원본 요청의 쿼리 문자열을 대체하지 않으며, 쿼리 문자열 파라미터가 추가됩니다. 
