...
3. 요청 파라미터 항목을 입력합니다. 
    ...
    - 요청 본문 파라미터
        ...
        - 설명: 파라미터의 설명을 입력합니다.
        - 모델: 요청 본문의 [모델](./console-guide/#_model?)을 선택합니다.
    - 콘텐츠 타입
...
1. 리소스 메서드를 선택합니다.
2. **응답** 탭을 클릭합니다.
3. 응답 HTTP 상태코드의 **추가 버튼**를 클릭하면 추가 입력 화면이 표시됩니다. 
...
자세한 내용은 [API 설명서](./console-guide/#_?)를 참고합니다.
...
> - 예:
> Access-Control-Allow-Origin: https://console-apigw.cloud.toast.com
