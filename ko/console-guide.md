...
- API Key를 적용하고자하는 스테이지는 사용량 계획과 연결해야합니다. (자세한 방법은 [사용량 계획 > 사용량 계획에 스테이지 연결](./console-guide/#_31) 를 참고하세요.)
- 유효한 API Key 값인지 검사합니다.
- API Key가 연결된 사용량 계획의 요청 한도를 검사합니다. (사용량 계획의 요청 한도 설정하는 자세한 방법은 [사용량 계획 > 사용량 계획 생성](./console-guide/#_28) 를 참고하세요.)
