...
자세한 내용은 [요청 제한 정책](/.console-guide/#_request_policy)을 참고하세요.
...
1. 판교와 평촌 리전의 각 API Gateway 스테이지에 생성한 사용자 지정 도메인을 연결합니다. 자세한 방법은 [사용자 지정 도메인을 스테이지에 연결 가이드](./console-guide/#_??)를 참고하세요.
