...
> - 일반 응답에 대한 응답 타임아웃은 **최대 60초**입니다. 백엔드 엔드포인트 서비스에서 응답이 지연되는 경우 타임아웃이 발생할 수 있습니다.
> - HTTP Streaming(SSE/chunked) 응답은 전체 응답 시간을 **최대 10분**까지 유지할 수 있습니다. 또한 백엔드 엔드포인트가 데이터를 전송하지 않는 간격은 **최대 60초**이며, 전체 응답 시간(10분) 또는 무전송 간격(60초)을 초과하면 연결이 종료됩니다.
