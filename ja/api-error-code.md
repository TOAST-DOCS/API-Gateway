...
|400102001|Invalid Swagger file.|Swaggerファイル形式が正しくありません。|
|400102002|Could not find Swagger info.|Swaggerファイルにinfoフィールドが存在しません。|
|400102004|Could not find Swagger paths.|Swaggerデータにpathsフィールドが存在しません。|
|400102005|Invalid x-nhncloud-apigateway plugins.|x-nhncloud-apigateway pluginsフィールドに無効な値があります。|
|400102006|Invalid path string.|pathsフィールドに無効なリソースパスがあります。|
|400102007|Invalid model schema.|definitionsフィールドに無効なモデルスキーマ定義があります。|
|400102008|Invalid path parameter data.|parametersフィールドに無効なparameter定義があります。|
|400102009|Invalid path response data.|responsesフィールドに無効なresponse定義があります。|
|400102010|Invalid model reference.|responsesまたはparametersでdefinitionsに定義されていないモデル名を参照しています。|
|400102011|Invalid content-type in produces/consumes fields.|有効なコンテンツタイプではありません。|
