...
API Gatewayは、API呼び出し時の認証/認可のためにUser Access Keyトークンを使用します。User Access Keyトークンは、User Access Keyに基づいて発行されるBearerタイプの一時的なアクセストークンです。User Access Keyトークンの発行及び使用に関する詳細は、[User Access Keyトークン](/ja/nhncloud/ja/public-api/user-access-key-token/)を参照してください。
...
| resourceList[2].resourcePluginList[0].pluginConfigJson | Object   | [リソースプラグインタイプ](./api-guide-v2.0/#resource-plugin)別のJSON設定値参考                 |
...
- リソースメソッドは任意入力です。作成されたリソースパスの下にメソッドを追加するには[リソースメソッド作成](./api-guide-v2.0/#create-resource-methods) APIを使用する必要があります。
...
| resourcePathList[0].pathPluginList[0].pluginConfigJson | Object | 必須 | なし | なし | [リソースプラグインタイプ別のJSON設定値](./api-guide-v2.0/#resource-plugin)参考。|
...
| resourcePathList[0].methodList[0].methodPluginList[0].pluginConfigJson | Object | 必須 | なし | なし | [リソースプラグインタイプ別のJSON設定値](./api-guide-v2.0/#resource-plugin)参考。|
...
| resourceList[1].resourcePluginList[0].pluginConfigJson | Object   | [リソースプラグインタイプ別のJSON設定値](./api-guide-v2.0/#resource-plugin)参考                 |
...
| methodList[0].methodPluginList[0].pluginConfigJson | Object | 必須 | なし | なし | [リソースプラグインタイプ別のJSON設定値](./api-guide-v2.0/#resource-plugin)参考。|
...
| resourceList[0].resourcePluginList[0].pluginConfigJson | Object   | [リソースプラグインタイプ別のJSON設定値](./api-guide-v2.0/#resource-plugin)参考                 |
...
- リソースパスに設定可能なプラグインのみ設定できます。詳細については、[リソースプラグイン](./api-guide-v2.0/#resource-plugin)を参照してください。
...
| pathPluginList[0].pluginConfigJson | Object | 条件付き必須 | なし | なし | [リソースプラグインタイプ別のJSON設定値](./api-guide-v2.0/#resource-plugin)参考、 deleteフィールドがfalseの場合は必須入力|
...
- deleteフィールドをtrueに設定すると、リクエストしたプラグインタイプのプラグインが削除されます。 deleteフィールドがtrueの場合、pluginConfigJsonフィールドは定義する必要はありません。
- リソースメソッドに設定可能なプラグインのみ設定できます。詳細については[リソースプラグイン](./api-guide-v2.0/#resource-plugin)を参照してください。
...
| methodPluginList[0].pluginConfigJson | Object | 条件付き必須 | なし | なし | [リソースプラグインタイプ別のJSON設定値](./api-guide-v2.0/#resource-plugin)参考、 deleteフィールドがfalseの場合は必須入力|
...
| swaggerData.paths.{path}.{operation}.x-nhncloud-apigateway.plugins.{pluginCode} | Object | 必須 | なし | {pluginCode} HTTP, MOCK, CORS, SET_REQUEST_HEADER, SET_RESPONSE_HEADER, ADD_REQUEST_QUERY_PARAMETER | [リソースプラグインタイプEnumコード](./enum-code/#resource-plugin-type)参考。 [リソースプラグインタイプ](./api-guide-v2.0/#resource-plugin)別JSON設定値参考。 |
...
* ステージリソースプラグインの詳細については[ステージリソースプラグイン](./api-guide-v2.0/#stage-resource-plugin)を参照します。
...
|stageResourceList[0].stageResourcePluginList[0].pluginConfigJson       |Object  |[リソースプラグインタイプ](./api-guide-v2.0/#resource-plugin), [ステージプラグインタイプ](./api-guide-v2.0/#stage-resource-plugin)別設定JSON参考          |
...
* ステージリソースプラグインの詳細については[ステージリソースプラグイン](./api-guide-v2.0/#stage-resource-plugin)を参照してください。
...
| stageResourcePluginList[0] | Object | 必須 | なし | なし | ステージリソースプラグイン別JSON形式のオブジェクト<br>[ステージリソースプラグイン](./api-guide-v2.0/#stage-resource-plugin)参考|
...
- ステージ配布リクエスト後、ステージ配布成否は[最近のステージ配布結果照会](./api-guide-v2.0/#query-result-of-recent-stage-deployment)で確認できます。 
...
- [ステージ配布](./api-guide-v2.0/#deploy-stage)の結果を照会できます。
...
|latestStageDeployResult.stageResourceList[0].stageResourcePluginList[0].pluginConfigJson       |Object  |[リソースプラグインタイプ](./api-guide-v2.0/#resource-plugin), [ステージプラグインタイプ](./api-guide-v2.0/#stage-resource-plugin)別設定JSON参考         |
