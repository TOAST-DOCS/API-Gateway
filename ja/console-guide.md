...
詳細は[リクエスト制限ポリシー](/.console-guide/#_request_policy)を参照してください。
...
4. GSLBドメイン: API Gatewayリージョン冗長構成をするにはGSLBドメインを入力します。 API Gatewayリージョン冗長化ガイドの詳細については[API Gatewayリージョン冗長化ガイド](./console-guide/#_??)を参照してください。
...
1. パンギョとピョンチョンリージョンの各API Gatewayステージに作成したユーザー指定ドメインを接続します。詳しい方法は[ユーザー指定ドメインをステージに接続するガイド](./console-guide/#_??)を参照してください。
