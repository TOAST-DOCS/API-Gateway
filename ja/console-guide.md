...
<a id="access-log"></a>
### 事前呼び出しAPI(Pre-call API) { #access-log }
...
<a id="pre-call-api"></a>
### バックエンドエンドポイントURL再定義 { #pre-call-api }
...
### リクエスト制限ポリシー { #request-validation }
...
### リクエスト有効性検査 { #request-restriction-policy }
