...
| gatewayResponseList[0].gatewayResponseType | Enum   | [ゲートウェイレスポンスタイプEnumコード](./enum-code/#_7)参考 |
...
| 名前              | タイプ   | 必須かどうか | デフォルト値 | 有効範囲          | 説明                                              |
| ----------------- | ------ | ----- | --- | ---------------- | ------------------------------------------------- |
| gatewayResponseType        | Enum | 必須  | なし | [ゲートウェイレスポンスタイプEnumコード](./enum-code/#_7) |  |
...
| gatewayResponse.gatewayResponseType | Enum   | [ゲートウェイレスポンスタイプEnumコード](./enum-code/#_7)参考 |
