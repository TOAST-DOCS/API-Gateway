...
## Application Service > API Gateway > API v1.0 Guide { #application-service-api-gateway-api-v10-guide }
...
- You can query the result of [Deploy Stage](./api-guide-v1.0/#deploy-stage). 
